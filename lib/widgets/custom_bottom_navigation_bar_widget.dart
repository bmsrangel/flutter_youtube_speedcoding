...
class CustomBottomNavigationBarWidget extends StatefulWidget {
  ...
  /// The z-coordinate of this [CustomBottomNavigationBarWidget].
  ///
  ...
  /// Defines the layout and behavior of a [CustomBottomNavigationBarWidget].
  ///
  ...
  /// The color of the [CustomBottomNavigationBarWidget] itself.
  ///
        ...
        child: Column(
          ...
          children: <Widget>[
            _TileIcon(
              ...
              animation: animation,
              iconSize: item.label != null ? iconSize : iconSize + 18.0,
              selected: selected,
              item: item,
...
class _CustomBottomNavigationBarWidgetState
  ...
  @override
  void didUpdateWidget(CustomBottomNavigationBarWidget oldWidget) {
...
class _Circle {
  ...
  final _CustomBottomNavigationBarWidgetState state;
  final int index;
  final Color color;
